...
(function () {
	...
	if (features.back_to_top_action_btn.enabled) {
		...
		actionBtn.style.bottom = features.hidden.right_feedback_action_balloon.enabled
			? "90px"
			: "155px";
